...
import { Project, ProjectStatus, ProjectType, CategoryConfig } from '../../types';
      ...
      <div className="w-full max-w-sm rounded-xl border border-zinc-800 bg-zinc-900 shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between border-t border-zinc-800 bg-zinc-900/50 p-4">
          ...
          <div className="flex items-center gap-2">
            <button onClick={onClose} className="rounded-md px-3 py-1.5 text-xs font-medium text-zinc-400 hover:bg-zinc-800 hover:text-white">Cancel</button>
            <button 
            ...
            >
              <Check size={14} /> {editingProject ? 'Save Changes' : 'Create'}
            </button>
          </div>
        </div>
      </div>
